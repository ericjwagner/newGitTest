#!/usr/bin/env python3
"""Weekly Tadpoles photo sync for Madden.
...
events response. As a best-effort heuristic, an event is treated as "Madden plus
...
def main():
    ...
    parser.add_argument("--child-name", default=os.environ.get("TADPOLES_CHILD_NAME", "Madden"))
